...
// Publications are fetched at runtime from /publications.json, generated by the
// Jekyll site from _publications/*.md — that collection is the single source of
// truth; this file has no publication data of its own.
...
function App() {
  ...
  useEffect(() => {
    fetch('/publications.json')
      ...
      .catch((err) => console.warn('Could not load /publications.json', err));
  }, []);
