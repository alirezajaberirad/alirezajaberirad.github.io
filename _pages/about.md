---
permalink: /
title: "PhD Researcher in Efficient AI & Hardware-Software Co-Design"
author_profile: true
redirect_from: 
  - /about/
  - /about.html
...
.pub-badge { display: inline-block; vertical-align: text-bottom; font-size: 0.75em; line-height: 1.6; padding: 0.05em 0.6em; margin-left: 0.4em; border: 1.5px solid var(--global-border-color); border-radius: 4px; color: var(--global-text-color); text-decoration: none; white-space: nowrap; }
...
<div id="news-list" class="two-col-list">
  ...
  <div class="two-col-row news-item"><div class="two-col-left">August 2026</div><div class="two-col-right">My Advanced Intelligent Systems paper is published now! <a href="https://doi.org/10.1002/aisy.70500" class="pub-badge">access here</a></div></div>
  <div class="two-col-row news-item"><div class="two-col-left">July 2026</div><div class="two-col-right">My Nature Communications paper is published now! <a href="https://doi.org/10.1038/s41467-026-76067-5" class="pub-badge">access here</a></div></div>
...
<div class="two-col-list">
  ...
  <div class="two-col-row row-tile" tabindex="0" role="button" aria-label="View poster: A New Era of AI: Efficient Software + Brain-Inspired Hardware" onclick="showPres('/images/2025_Graduate_Researh_3Minute_Thesis_Talk.PNG','2025 3-Minute Thesis Talk')" onkeydown="if(event.key==='Enter'||event.key===' '){event.preventDefault();showPres('/images/2025_Graduate_Researh_3Minute_Thesis_Talk.PNG','2025 3-Minute Thesis Talk')}"><div class="two-col-left">Talk<br><span style="font-weight: 400;">2025</span></div><div class="two-col-right"><span style="font-weight: 500;">A New Era of AI: Efficient Software + Brain-Inspired Hardware</span><br><span style="font-size: 0.85em; opacity: 0.65;">ECE 3-Minute Thesis Competition</span></div></div>
