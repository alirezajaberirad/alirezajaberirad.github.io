...
.pub-tile { cursor: pointer; border-radius: 6px; transition: background-color 0.15s ease; }
.pub-tile:hover, .pub-tile:focus-visible { background-color: rgba(128,128,128,0.14); outline: none; }
</style>
